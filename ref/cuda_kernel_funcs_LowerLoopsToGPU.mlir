...
module attributes {gpu.container_module} {
  func.func @cuda_kernel_0(%arg0: !tf_framework.op_kernel_context {input.fake_symbolic_shape = #tf_type.shape<137x2>, input.from = "7:0", input.has_one_use = true}, %arg1: memref<?x2xi32> {input.fake_symbolic_shape = #tf_type.shape<137x4>, input.from = "4:0", input.has_one_use = true}, %arg2: memref<?x4xf32> {input.fake_symbolic_shape = #tf_type.shape<137x2>, input.from = "8:0", input.has_one_use = true}, %arg3: memref<?x2xi32> {input.fake_symbolic_shape = #tf_type.shape<137x4>, input.from = "5:0", input.has_one_use = true}, %arg4: memref<?x4xf32> {input.fake_symbolic_shape = #tf_type.shape<137x2>, input.from = "9:0", input.has_one_use = true}, %arg5: memref<?x2xi32> {input.fake_symbolic_shape = #tf_type.shape<137x4>, input.from = "6:0", input.has_one_use = true}, %arg6: memref<?x4xf32>) -> (memref<?x4xf32>, memref<?x4xf32>, memref<?x4xf32>) attributes {BatchComputeFusion, _nano_compiler_group_idx = 0 : i64, _nano_compiler_kernel_size = 1 : i64, _nano_compiler_op_idx = "10", _nano_compiler_v2, batch_compute_pattern = "FuseGatherV2OpPattern", llvm.emit_c_interface, tf_entry} {
    ...
    %21 = arith.select %20, %19, %c40960 : index
    %22 = affine.apply #map()[%21]
    gpu.launch_func  @cuda_kernel_0_kernel::@cuda_kernel_0_kernel blocks in (%22, %c1, %c1) threads in (%c512, %c1, %c1) args(%arg1 : memref<?x2xi32>, %arg3 : memref<?x2xi32>, %arg5 : memref<?x2xi32>, %0 : memref<?xi32>, %4 : index, %arg2 : memref<?x4xf32>, %2 : memref<?x4xf32>, %7 : memref<?xi32>, %11 : index, %arg4 : memref<?x4xf32>, %9 : memref<?x4xf32>, %14 : memref<?xi32>, %18 : index, %arg6 : memref<?x4xf32>, %16 : memref<?x4xf32>)
    tf_framework.dealloc(%arg0, %14) : memref<?xi32>
    tf_framework.dealloc(%arg0, %7) : memref<?xi32>
    tf_framework.dealloc(%arg0, %0) : memref<?xi32>
    return %2, %9, %16 : memref<?x4xf32>, memref<?x4xf32>, memref<?x4xf32>
  }
  gpu.module @cuda_kernel_0_kernel attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<index, 32 : i32>>} {
    gpu.func @cuda_kernel_0_kernel(%arg0: memref<?x2xi32>, %arg1: memref<?x2xi32>, %arg2: memref<?x2xi32>, %arg3: memref<?xi32>, %arg4: index, %arg5: memref<?x4xf32>, %arg6: memref<?x4xf32>, %arg7: memref<?xi32>, %arg8: index, %arg9: memref<?x4xf32>, %arg10: memref<?x4xf32>, %arg11: memref<?xi32>, %arg12: index, %arg13: memref<?x4xf32>, %arg14: memref<?x4xf32>) kernel {
      %0 = gpu.block_id  x
      %1 = gpu.block_id  y
      %2 = gpu.block_id  z
      %3 = gpu.thread_id  x
...
module attributes {gpu.container_module} {
  func.func @cuda_kernel_0(%arg0: !tf_framework.op_kernel_context {input.fake_symbolic_shape = #tf_type.shape<137x2>, input.from = "7:0", input.has_one_use = true}, %arg1: memref<?x2xi32> {input.fake_symbolic_shape = #tf_type.shape<137x4>, input.from = "4:0", input.has_one_use = true}, %arg2: memref<?x4xf32> {input.fake_symbolic_shape = #tf_type.shape<137x2>, input.from = "8:0", input.has_one_use = true}, %arg3: memref<?x2xi32> {input.fake_symbolic_shape = #tf_type.shape<137x4>, input.from = "5:0", input.has_one_use = true}, %arg4: memref<?x4xf32> {input.fake_symbolic_shape = #tf_type.shape<137x2>, input.from = "9:0", input.has_one_use = true}, %arg5: memref<?x2xi32> {input.fake_symbolic_shape = #tf_type.shape<137x4>, input.from = "6:0", input.has_one_use = true}, %arg6: memref<?x4xf32>) -> (memref<?x4xf32>, memref<?x4xf32>, memref<?x4xf32>) attributes {BatchComputeFusion, _nano_compiler_group_idx = 0 : i64, _nano_compiler_kernel_size = 1 : i64, _nano_compiler_op_idx = "10", _nano_compiler_v2, batch_compute_pattern = "FuseGatherV2OpPattern", llvm.emit_c_interface, tf_entry} {
    ...
    gpu.launch_func  @cuda_kernel_0_kernel::@cuda_kernel_0_kernel blocks in (%29, %c1, %c1) threads in (%c512, %c1, %c1) args(%arg1 : memref<?x2xi32>, %arg3 : memref<?x2xi32>, %arg5 : memref<?x2xi32>, %0 : memref<?xi32>, %4 : index, %arg2 : memref<?x4xf32>, %2 : memref<?x4xf32>, %7 : memref<?xi32>, %11 : index, %arg4 : memref<?x4xf32>, %9 : memref<?x4xf32>, %14 : memref<?xi32>, %18 : index, %arg6 : memref<?x4xf32>, %16 : memref<?x4xf32>)
    tf_framework.dealloc(%arg0, %14) : memref<?xi32>
    tf_framework.dealloc(%arg0, %7) : memref<?xi32>
    tf_framework.dealloc(%arg0, %0) : memref<?xi32>
    return %2, %9, %16 : memref<?x4xf32>, memref<?x4xf32>, memref<?x4xf32>
