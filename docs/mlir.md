...
class AddOp : public ::mlir::Op<AddOp, LmhloOp::Trait, ::mlir::OpTrait::SameTypeOperands, ::mlir::OpTrait::Elementwise, /* Other traits */>

// Inheritance: AddOp -> Op -> Traits
...
public:
  ...
  template <typename ConcreteOp = AddOp>
  struct Trait : public detail::LmhloOpTrait<AddOp> {};
  /// Return the operand that is the output buffer
  Value getResultBuffer();
};

template <typename ConcreteOp = AddOp>
struct LmhloOpTrait : public ::mlir::OpInterface<LmhloOp, detail::LmhloOpInterfaceTraits>::Trait<AddOp> {
  /// Return the operand that is the output buffer
  Value getResultBuffer() {
    /// By default, the result buffer is the last operand
    unsigned num_operands = this->getOperation()->getNumOperands();
...
static detail::InterfaceMap getInterfaceMap() {
  // Traits<ConcreteType> = LmhloOp::Trait<AddOp>
