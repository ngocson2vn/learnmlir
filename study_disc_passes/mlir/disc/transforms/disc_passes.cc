...
#include "disc_passes.h"

namespace mlir {
namespace disc_ral {

#define GEN_PASS_REGISTRATION
#define GEN_PASS_DECL_DISCLHLOLEGALIZEROOTSTOPARALLELLOOPSPASS
#define GEN_PASS_DEF_DISCLHLOLEGALIZEROOTSTOPARALLELLOOPSPASS
...
struct DiscLhloLegalizeRootsToParallelLoops : public impl::DiscLhloLegalizeRootsToParallelLoopsPassBase<DiscLhloLegalizeRootsToParallelLoops> {
  ...
  void getDependentDialects(DialectRegistry& registry) const override {
    impl::DiscLhloLegalizeRootsToParallelLoopsPassBase<DiscLhloLegalizeRootsToParallelLoops>::getDependentDialects(registry);
...
void registerAllDiscPasses() { registerDISCPasses(); }
