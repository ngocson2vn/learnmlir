...
struct PrintNestingPass
    : public PassWrapper<PrintNestingPass, OperationPass<>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(PrintNestingPass)

  StringRef getArgument() const final { return "print-nesting"; }
  StringRef getDescription() const final { return "Various printing."; }
...
namespace mlir {
void registerPrintNestingPass() {
  PassRegistration<PrintNestingPass>();
}
} // namespace mlir